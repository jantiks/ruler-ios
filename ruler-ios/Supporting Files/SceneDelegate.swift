...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // setting the inital view controller
    ...
    /// if the user has already seen the first screen, then it returnes the RulerViewController.
    ...
    private func getInitialViewController() -> UIViewController? {
        ...
        return storyboard.instantiateViewController(withIdentifier: "RulerViewController")
    }
}
